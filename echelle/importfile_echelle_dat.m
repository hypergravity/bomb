function [w,f] = importfile_echelle_dat(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [W,F] = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   [W,F] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [w,f] = importfile('w20160119027s_0024.dat',1, 4096);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/03/09 11:57:36
